...
#-------------------------------------------------------------------------------
# Import data
weather_data <- read.csv(file.choose(), sep = ",")
View(weather_data)

sales_data <- read.csv(file.choose(), sep = ",")
View(sales_data)
...
# Correlation Matrix by Weekly Averages
corr_avg_master_df <- subset(avg_master_df, select = -c(1))
View(corr_avg_master_df)
ggcorr(corr_avg_master_df, label = TRUE)
...
mean_sales_rainfall$mean_rainfall <- mean_sales_rainfall$mean_rainfall * 100
