...
# Training model
logistic_model <- glm(as.factor(train$rain_tmrw) ~ min_temp + max_temp + sun_sh_hr + `9am_hum` + `9am_pres` +`3pm_temp` + `3pm_hum`,
                      data = train, 
                      family=binomial)
logistic_model
...
model2 <- rpart(rain_tmrw ~ min_temp + max_temp + sun_sh_hr + `9am_hum` + `9am_pres` + `3pm_temp` + `3pm_hum`, 
